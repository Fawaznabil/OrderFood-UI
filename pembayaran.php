			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="tekss" style="display: flex;">
						<div style="flex: 1;">
							<h3 style="margin-left: 9%;padding:20px">Pembayaran Makanan</h3>
						</div>
					</div>
				</div>
			</div>

			<div class="checkout-section mt-60 mb-60">
				<div class="container">
					<div class="row">
						<div class="col-lg-8">
						...
						<div class="col-lg-4">
							<div class="order-details-wrap">
								...
								<a href="histori-transaksi.php" class="boxed-btn">Place Order</a>
							</div>
						</div>
					</div>
				</div>
