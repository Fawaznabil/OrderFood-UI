                            ...
                            <table class="w-full whitespace-no-wrap" id="myTable" class="display">
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td>
                                            <a href="update-produk.php" class="btn btn-icon btn-warning btn-hover-scale me-5"
                                        ...
                                        <td>
                                            <a href="create-produk.php" class="btn btn-icon btn-warning btn-hover-scale me-5"
