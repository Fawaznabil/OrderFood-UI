                    ...
                    <div class="card-body p-9">
                        <div class="row g-6 g-xl-9 mb-6 mb-xl-9">
                            <div class="table-responsive">
                                    <div class="mb-3">
                                        <label for="NAMA" style="color:black" class="form-label">No Hp</label>
                                        <div class='invalid-feedback'>

                                        </div>
                                        <input type="text" class="form-control" name="NAMA" @error('NAMA') is-invalid
                                            @enderror id="NAMA" value="081234273947" readonly>
                                    </div>

                                    <div class="mb-3">
                                        <label for="NAMA" style="color:black" class="form-label">Alamat</label>
                                        <div class='invalid-feedback'>
                                    ...
                                    <div class="mb-3">
                                        <label for="text" style="color:black" class="form-label">Email</label>
                                        <div class='invalid-feedback'>

                                        </div>
                                        <input type="text" class="form-control" name="text" id="text" value="tya@gmail.com" readonly>
                                    </div>

                                    <div class="mb-3">
                                        <label for="deskripsi" style="color:black" class="form-label">Role</label>
                                        <div class='invalid-feedback'>

                                        </div>
                                        <input type="text" class="form-control" name="text" id="text" value="Pengguna" readonly>
                                    </div>
                            </div>
                        </div>
                    </div>
