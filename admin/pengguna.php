                            ...
                            <table class="w-full whitespace-no-wrap" id="myTable" class="display">
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td>
                                            <a href="update-pengguna.php" class="btn btn-icon btn-warning btn-hover-scale me-5"
                                        ...
                                        <td>
                                            <a href="create-pengguna.php" class="btn btn-icon btn-warning btn-hover-scale me-5"
                                                data-bs-toggle="modal" data-bs-target="#modalUbah"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
