                    ...
                    <div class="card-body p-9">
                        <div class="row g-6 g-xl-9 mb-6 mb-xl-9">
                            <div class="table-responsive">
                                    <div class="mb-3">
                                        <label for="NAMA" style="color:black" class="form-label">Judul</label>
                                        <div class='invalid-feedback'>

                                        </div>
                                        <input type="text" class="form-control" name="NAMA" @error('NAMA') is-invalid
                                            @enderror id="NAMA" value="Lorem ipsum dolor sit amet." readonly>
                                    </div>

                                    <div class="mb-3">
                                        <label for="NAMA" style="color:black" class="form-label">Kategori</label>
                                        <div class='invalid-feedback'>
                                    ...
                                    <div class="mb-3">
                                        <label for="NAMA" style="color:black" class="form-label">Tanggal Upload</label>
                                        <div class='invalid-feedback'>

                                        </div>
                                        <input type="text" class="form-control" name="NAMA" @error('NAMA') is-invalid
                                            @enderror id="NAMA" value="3 februari 2024" readonly>
                                    </div>

                                    <div class="mb-3">
                                        <label for="image" style="color: black" class="form-label">Pilih Gambar</label>
                                        <div class='invalid-feedback'></div>
                                        <img src="../assets/artikel1.jpg" alt="" style="max-width: 30%;">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control" name="deskripsi" @error('deskripsi')
                                            is-invalid @enderror id="deskripsi" readonly
                                            >Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus aliquam, sed quae assumenda provident unde blanditiis non in quis repellendus cumque, quaerat qui nostrum dolorem natus voluptates necessitatibus nesciunt ex.</textarea>
                                    </div>
                            </div>
                        </div>
                    </div>
