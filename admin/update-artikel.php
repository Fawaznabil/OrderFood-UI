                                ...
                                <form action="storeTamu" method="post" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="NAMA" @error('NAMA') is-invalid
                                            @enderror id="NAMA" value="Lorem ipsum dolor sit amet.">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="date" style="color:black" class="form-label">Tanggal Upload</label>
                                        <div class='invalid-feedback'>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control" name="deskripsi" @error('deskripsi')
                                            ...
                                            value="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus aliquam, sed quae assumenda provident unde blanditiis non in quis repellendus cumque, quaerat qui nostrum dolorem natus voluptates necessitatibus nesciunt ex.</textarea>
                                    </div>
